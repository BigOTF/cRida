...
const AboutUsText = () => {
  return (
    <div className='md:w-[710px] md:h-[417px] p-[8px] md:flex flex-col justify-center gap-[16px] hidden'>

      <div className='md:w-[610px] md:h-[292px] md:flex flex-col gap-[16px] md:p-[8px]'>

        <div className='md:w-[594px] md:h-[211px] flex flex-col gap-[16px]'>
          ...
          <a href='/about' className='md:w-[189px] md:h-[49px] md:text-[24px] leading-[32.74px] p-[8px]  bg-[#5810BF] text-white rounded-lg cursor-pointer'>
              More About Us
          </a>
