...
const AboutUsImage = () => {
  return (
    <div className='flex relative mt-[100px]'>
        <img src={aboutUsImage} className='w-[344.94px] h-[366px] ml-[30px] md:w-[492.69px] md:h-[450px] md:ml-[100px] absolute left-1 top-[-30px]' />
