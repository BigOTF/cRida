...
const SubHero = () => {
  return (
    <div className='bg-[#DEE7F5] w-full'>
       ...
       <div className='bg-white w-[368px] h-[65px] mx-[30px] md:mx-auto md:w-[1030px] md:h-[131px] flex justify-around items-center gap-[8px] md:gap-[40px] transform md:translate-y-[-50%] translate-y-[-80px]'>
