...
const SubHero = () => {
  return (
    <div className='bg-[#DEE7F5] w-full'>
       ...
       <div className='bg-white h-[65px] md:mx-auto md:w-[1030px] md:h-[131px] flex justify-around items-center gap-[8px] md:gap-[40px] transform md:translate-y-[-50%] translate-y-[-80px]'>
          <div className='flex flex-col md:gap-[8px] items-center'>
