    ...
    <div className='bg-[#DEE7F5] w-[428px]'>
       ...
       <div className='bg-white w-[428px] h-[65px] md:w-[1030px] md:h-[131px] flex mx-auto justify-around items-center gap-[8px] md:gap-[40px] transform md:translate-y-[-50%] translate-y-[-90px]'>
            ...
            <div className='flex flex-col md:gap-[8px] w-[62px] h-[49px] md:w-[219.5px] md:h-[83px] items-center'>
                ...
                <p className='text-[#363247] md:text-[20px] text-[16px] text-center md:leading-[27.28px] leading-[21.82px]'><span className='hidden md:block'>Happy </span>Clients</p>
            </div>
            <div className='flex flex-col md:gap-[8px] w-[62px] h-[49px] md:w-[219.5px] md:h-[83px] items-center'>
            ...
            <div className='flex flex-col md:gap-[8px] w-[62px] h-[49px] md:w-[219.5px] md:h-[83px] items-center'>
                ...
                <p className='text-[#363247] md:text-[20px] text-[16px] text-center md:leading-[27.28px] leading-[21.82px]'><span className='hidden md:block'>Professional </span>Drivers</p>
            </div>
       </div>
